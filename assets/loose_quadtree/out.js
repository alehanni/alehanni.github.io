...
var ASM_CONSTS = {
  124888: () => { if (document.fullscreenElement) return 1; },  
 124934: () => { return document.getElementById('canvas').width; },  
 124986: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125054: () => { document.exitFullscreen(); },  
 125081: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 125154: () => { if (document.fullscreenElement) return 1; },  
 125200: () => { return document.getElementById('canvas').width; },  
 125252: () => { return screen.width; },  
 125277: () => { document.exitFullscreen(); },  
 125304: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 125437: () => { return window.innerWidth; },  
 125463: () => { return window.innerHeight; },  
 125490: () => { if (document.fullscreenElement) return 1; },  
 125536: () => { return document.getElementById('canvas').width; },  
 125588: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125656: () => { if (document.fullscreenElement) return 1; },  
 125702: () => { return document.getElementById('canvas').width; },  
 125754: () => { return screen.width; },  
 125779: () => { return window.innerWidth; },  
 125805: () => { return window.innerHeight; },  
 125832: () => { if (document.fullscreenElement) return 1; },  
 125878: () => { return document.getElementById('canvas').width; },  
 125930: () => { return screen.width; },  
 125955: () => { document.exitFullscreen(); },  
 125982: () => { if (document.fullscreenElement) return 1; },  
 126028: () => { return document.getElementById('canvas').width; },  
 126080: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126148: () => { document.exitFullscreen(); },  
 126175: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 126233: () => { return screen.width; },  
 126258: () => { return screen.height; },  
 126284: () => { return window.screenX; },  
 126311: () => { return window.screenY; },  
 126338: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 126391: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 126462: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 126519: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 126775: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 126846: () => { if (document.fullscreenElement) return 1; },  
 126892: () => { return window.innerWidth; },  
 126918: () => { return window.innerHeight; },  
 126945: () => { if (document.pointerLockElement) return 1; }
};
