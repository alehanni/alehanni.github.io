...
var ASM_CONSTS = {
  124808: () => { if (document.fullscreenElement) return 1; },  
 124854: () => { return document.getElementById('canvas').width; },  
 124906: () => { return parseInt(document.getElementById('canvas').style.width); },  
 124974: () => { document.exitFullscreen(); },  
 125001: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 125074: () => { if (document.fullscreenElement) return 1; },  
 125120: () => { return document.getElementById('canvas').width; },  
 125172: () => { return screen.width; },  
 125197: () => { document.exitFullscreen(); },  
 125224: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 125357: () => { return window.innerWidth; },  
 125383: () => { return window.innerHeight; },  
 125410: () => { if (document.fullscreenElement) return 1; },  
 125456: () => { return document.getElementById('canvas').width; },  
 125508: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125576: () => { if (document.fullscreenElement) return 1; },  
 125622: () => { return document.getElementById('canvas').width; },  
 125674: () => { return screen.width; },  
 125699: () => { return window.innerWidth; },  
 125725: () => { return window.innerHeight; },  
 125752: () => { if (document.fullscreenElement) return 1; },  
 125798: () => { return document.getElementById('canvas').width; },  
 125850: () => { return screen.width; },  
 125875: () => { document.exitFullscreen(); },  
 125902: () => { if (document.fullscreenElement) return 1; },  
 125948: () => { return document.getElementById('canvas').width; },  
 126000: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126068: () => { document.exitFullscreen(); },  
 126095: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 126153: () => { return screen.width; },  
 126178: () => { return screen.height; },  
 126204: () => { return window.screenX; },  
 126231: () => { return window.screenY; },  
 126258: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 126311: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 126382: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 126439: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 126695: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 126766: () => { if (document.fullscreenElement) return 1; },  
 126812: () => { return window.innerWidth; },  
 126838: () => { return window.innerHeight; },  
 126865: () => { if (document.pointerLockElement) return 1; }
};
