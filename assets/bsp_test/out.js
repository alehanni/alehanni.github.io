...
var ASM_CONSTS = {
  92532: () => { if (document.fullscreenElement) return 1; },  
 92578: () => { return document.getElementById('canvas').width; },  
 92630: () => { return parseInt(document.getElementById('canvas').style.width); },  
 92698: () => { document.exitFullscreen(); },  
 92725: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 92798: () => { if (document.fullscreenElement) return 1; },  
 92844: () => { return document.getElementById('canvas').width; },  
 92896: () => { return screen.width; },  
 92921: () => { document.exitFullscreen(); },  
 92948: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93081: () => { return window.innerWidth; },  
 93107: () => { return window.innerHeight; },  
 93134: () => { if (document.fullscreenElement) return 1; },  
 93180: () => { return document.getElementById('canvas').width; },  
 93232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93300: () => { if (document.fullscreenElement) return 1; },  
 93346: () => { return document.getElementById('canvas').width; },  
 93398: () => { return screen.width; },  
 93423: () => { return window.innerWidth; },  
 93449: () => { return window.innerHeight; },  
 93476: () => { if (document.fullscreenElement) return 1; },  
 93522: () => { return document.getElementById('canvas').width; },  
 93574: () => { return screen.width; },  
 93599: () => { document.exitFullscreen(); },  
 93626: () => { if (document.fullscreenElement) return 1; },  
 93672: () => { return document.getElementById('canvas').width; },  
 93724: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93792: () => { document.exitFullscreen(); },  
 93819: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 93877: () => { return screen.width; },  
 93902: () => { return screen.height; },  
 93928: () => { return window.screenX; },  
 93955: () => { return window.screenY; },  
 93982: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94035: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 94106: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 94163: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94419: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 94490: () => { if (document.fullscreenElement) return 1; },  
 94536: () => { return window.innerWidth; },  
 94562: () => { return window.innerHeight; },  
 94589: () => { if (document.pointerLockElement) return 1; }
};
